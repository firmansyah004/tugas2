...
<Text style={[styles.largeText, styles.textStyle]}>Tugas 2 Weather</Text>
...
<Text style={[styles.largeText2, styles.textStyle, styles.black]}>Firmansyah</Text>
<Text style={[styles.largeText2, styles.textStyle, styles.black]}>2015150060</Text>    
      </ImageBackground>
    );
  }
}
